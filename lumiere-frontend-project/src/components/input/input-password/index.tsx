  ...
  return (
    <div className="relative">
      <input
        ...
        className={`h-10 w-full rounded border-[1px] bg-gray-200 pl-4 pr-12 font-mont text-gray-800 transition-all focus:outline-none focus:outline-offset-0 focus:outline-gray-400/50 ${
          className ? className : ''
