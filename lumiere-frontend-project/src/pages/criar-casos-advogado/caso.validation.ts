...
export const createCaseSchema = Yup.object().shape({
  ...
  nomecliente: Yup.string().matches(/^[A-Za-záàâãéèêíïóôõöúçñÁÀÂÃÉÈÍÏÓÔÕÖÚÇÑ ]+$/, "Escreva apenas caracteres maiúsculos ou minúsculos").
  required('Digite o nome do cliente do caso'),
});
